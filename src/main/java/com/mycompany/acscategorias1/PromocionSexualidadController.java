 ...
 * @author eunic
 */
public class PromocionSexualidadController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubSalud;
    @FXML
    private TextField txtTipoSalud;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cBoxSubSalud.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubSalud.getValue();
                String tipo = this.txtTipoSalud.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubSalud.getValue() == null || txtTipoSalud.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
