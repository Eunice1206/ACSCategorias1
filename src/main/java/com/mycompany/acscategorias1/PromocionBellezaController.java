 ...
 * @author eunic
 */
public class PromocionBellezaController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubBelleza;
    @FXML
    private TextField txtTipoBelleza;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ObservableList<String> opciones = FXCollections.observableArrayList(
                ...
                "Depilación",
                "Desodorante",
                "Higiene y protección femenina",
                "Incontinencia",
                "Jabones",
                "Papel higiénico y pañuelos"
        );
        cBoxSubBelleza.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubBelleza.getValue();
                String tipo = this.txtTipoBelleza.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubBelleza.getValue() == null || txtTipoBelleza.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
