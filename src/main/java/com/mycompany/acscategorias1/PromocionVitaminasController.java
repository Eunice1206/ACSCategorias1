 ...
 * @author eunic
 */
public class PromocionVitaminasController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubVitaminas;
    @FXML
    private TextField txtTipoVitaminas;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cBoxSubVitaminas.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubVitaminas.getValue();
                String tipo = this.txtTipoVitaminas.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubVitaminas.getValue() == null || txtTipoVitaminas.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
