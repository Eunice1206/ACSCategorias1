 ...
 * @author eunic
 */
public class PromocionAlimentosController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubAlimentos;
    @FXML
    private TextField txtTipoAlimentos;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ObservableList<String> opciones = FXCollections.observableArrayList(
        ...
        cBoxSubAlimentos.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubAlimentos.getValue();
                String tipo = this.txtTipoAlimentos.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubAlimentos.getValue() == null || txtTipoAlimentos.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
