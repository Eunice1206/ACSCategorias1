 ...
 * @author eunic
 */
public class PromocionBotiquinController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubBotiquin;
    @FXML
    private TextField txtTipoBotiquin;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cBoxSubBotiquin.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubBotiquin.getValue();
                String tipo = this.txtTipoBotiquin.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubBotiquin.getValue() == null || txtTipoBotiquin.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
