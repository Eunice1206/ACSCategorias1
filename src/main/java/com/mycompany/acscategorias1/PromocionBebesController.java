 ...
 * @author eunic
 */
public class PromocionBebesController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubBebes;
    @FXML
    private TextField txtTipoBebes;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cBoxSubBebes.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubBebes.getValue();
                String tipo = this.txtTipoBebes.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubBebes.getValue() == null || txtTipoBebes.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
