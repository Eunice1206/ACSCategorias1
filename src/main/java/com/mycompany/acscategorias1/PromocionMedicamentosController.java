 ...
 * @author eunic
 */
public class PromocionMedicamentosController implements Initializable {


    @FXML
    private ComboBox<String> cBoxSubMedicamento;
    @FXML
    private TextField txtTipoMedicamento;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cBoxSubMedicamento.setItems(opciones);
    ...
    private void agregarPromocion(ActionEvent event) throws DAOException {
        try{
            if(validarCamposVacios()!=true){
                ...
                String subcategoria = this.cBoxSubMedicamento.getValue();
                String tipo = this.txtTipoMedicamento.getText();
    ...
    private Boolean validarCamposVacios(){
        Boolean resultado;
        if(cBoxSubMedicamento.getValue() == null || txtTipoMedicamento.getText().isEmpty() || cBoxPromocion.getValue() == null || txtCantidadMinima.getText().isEmpty() || dateInicio.getValue() == null || dateFin.getValue() == null){
            resultado=false;
        }else{
            resultado = true;
        }
